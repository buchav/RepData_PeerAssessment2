...
relevant.columns$PROPDMGEXP<-as.character(relevant.columns$PROPDMGEXP)
relevant.columns$CROPDMGEXP<-as.character(relevant.columns$CROPDMGEXP)
relevant.columns$CROPDMGEXP[is.na(relevant.columns$CROPDMGEXP)]="NA"
relevant.columns$PROPDMGEXP[is.na(relevant.columns$PROPDMGEXP)]="NA"
